...
`2c537090...`. Live GitHub currently reports `mergeable=true`, but that conflict
signal does not satisfy trusted-main reconciliation and is not release evidence.
The latest distinct Codex release evidence also covers a moved head, while
unresolved P1/P2 review history remains. PR #93 therefore requires trusted-main
