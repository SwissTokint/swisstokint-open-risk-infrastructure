...
Updated: `2026-08-21T16:00:00+02:00`
...
- state: `OPEN / NOT_MERGED / NOT_MERGEABLE / BLOCKED_EXACT_HEAD_SECURITY_P1 / TRUSTED_MAIN_RECONCILIATION_REQUIRED`;
...
- state: `OPEN / NOT_MERGED / NOT_MERGEABLE / UNTRUSTED / RECONCILIATION_REQUIRED`;
...
4. `PR97_TRUSTED_MAIN_DRIFT_AFTER_PR102` — PR #97 base remains `0564aecd...` while trusted main is `62edca5d...`; current live mergeability is false and the eventual repair must reconcile to trusted main before release.
...
6. `PR93_TRUSTED_MAIN_RECONCILIATION_AND_FRESH_EXACT_HEAD_REVIEW_REQUIRED` — current live mergeability is false on historical base.
