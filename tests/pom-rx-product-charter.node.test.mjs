...
test("product charter keeps POM-RX as the principal product and DAGR as a profile", () => {
  ...
  for (const forbiddenPeerClaim of [
    /DAGR is (?:an? )?(?:peer|separate|second|standalone|autonomous) (?:product|offering)/i,
    /POM-RX and DAGR are (?:peer|coequal|separate) products/i,
