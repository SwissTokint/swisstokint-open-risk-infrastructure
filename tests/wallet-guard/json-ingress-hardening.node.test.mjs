...
test('shared branded canonicalizer rejections are normalized to the ingress diagnostic family', () => {
  for (const raw of [
...
test('matching-message unrelated TypeError preserves exact runtime provenance', () => {
